...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(visual-fill-column ctable deferred epc emacsql emacsql-sqlite emacsql-sqlite3 doom-themes jeison (e2ansi :location (recipe :fetcher github :repo "Lindydancer/e2ansi")) websocket simple-httpd f)
